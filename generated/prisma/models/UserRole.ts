...
export type UserRoleOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"tenantId" | "userId" | "roleId" | "assignedAt", ExtArgs["result"]["userRole"]>
...
export interface UserRoleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const userRoleWithTenantIdOnly = await prisma.userRole.findMany({ select: { tenantId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many UserRoles and only return the `tenantId`
   * const userRoleWithTenantIdOnly = await prisma.userRole.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more UserRoles and only return the `tenantId`
   * const userRoleWithTenantIdOnly = await prisma.userRole.updateManyAndReturn({
   *   select: { tenantId: true },
   *   where: {
   *     // ... provide filter here
   *   },
