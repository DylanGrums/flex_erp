...
export type CustomerAddressMinAggregateOutputType = {
  ...
  kind: $Enums.CustomerAddressKind | null
}
...
export type CustomerAddressGroupByOutputType = {
  ...
  customerId: string
  addressId: string
  kind: $Enums.CustomerAddressKind
  _count: CustomerAddressCountAggregateOutputType | null
  _min: CustomerAddressMinAggregateOutputType | null
  _max: CustomerAddressMaxAggregateOutputType | null
}
...
export type CustomerAddressWhereInput = {
  ...
  storeId?: Prisma.UuidFilter<"CustomerAddress"> | string
  customerId?: Prisma.UuidFilter<"CustomerAddress"> | string
  addressId?: Prisma.UuidFilter<"CustomerAddress"> | string
  kind?: Prisma.EnumCustomerAddressKindFilter<"CustomerAddress"> | $Enums.CustomerAddressKind
...
export type CustomerAddressWhereUniqueInput = Prisma.AtLeast<{
  tenantId_storeId_customerId_addressId_kind?: Prisma.CustomerAddressTenantIdStoreIdCustomerIdAddressIdKindCompoundUniqueInput
  AND?: Prisma.CustomerAddressWhereInput | Prisma.CustomerAddressWhereInput[]
  OR?: Prisma.CustomerAddressWhereInput[]
  NOT?: Prisma.CustomerAddressWhereInput | Prisma.CustomerAddressWhereInput[]
  tenantId?: Prisma.UuidFilter<"CustomerAddress"> | string
  ...
  customer?: Prisma.XOR<Prisma.CustomerScalarRelationFilter, Prisma.CustomerWhereInput>
  address?: Prisma.XOR<Prisma.AddressScalarRelationFilter, Prisma.AddressWhereInput>
}, "tenantId_storeId_customerId_addressId_kind">
...
export type CustomerAddressScalarWhereWithAggregatesInput = {
  ...
  storeId?: Prisma.UuidWithAggregatesFilter<"CustomerAddress"> | string
  ...
  kind?: Prisma.EnumCustomerAddressKindWithAggregatesFilter<"CustomerAddress"> | $Enums.CustomerAddressKind
}
...
export type CustomerAddressUpdateInput = {
  kind?: Prisma.EnumCustomerAddressKindFieldUpdateOperationsInput | $Enums.CustomerAddressKind
...
export type CustomerAddressTenantIdStoreIdCustomerIdAddressIdKindCompoundUniqueInput = {
  tenantId: string
  storeId: string
  customerId: string
  addressId: string
...
export type EnumCustomerAddressKindFieldUpdateOperationsInput = {
  set?: $Enums.CustomerAddressKind
}
...
export type CustomerAddressOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"tenantId" | "storeId" | "customerId" | "addressId" | "kind", ExtArgs["result"]["customerAddress"]>
...
export interface CustomerAddressDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const customerAddressWithTenantIdOnly = await prisma.customerAddress.findMany({ select: { tenantId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many CustomerAddresses and only return the `tenantId`
   * const customerAddressWithTenantIdOnly = await prisma.customerAddress.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more CustomerAddresses and only return the `tenantId`
   * const customerAddressWithTenantIdOnly = await prisma.customerAddress.updateManyAndReturn({
   *   select: { tenantId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface CustomerAddressFieldRefs {
  ...
  readonly storeId: Prisma.FieldRef<"CustomerAddress", 'String'>
  readonly customerId: Prisma.FieldRef<"CustomerAddress", 'String'>
  readonly addressId: Prisma.FieldRef<"CustomerAddress", 'String'>
  readonly kind: Prisma.FieldRef<"CustomerAddress", 'CustomerAddressKind'>
}
