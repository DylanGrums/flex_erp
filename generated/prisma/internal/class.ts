...
/**
  ...
  /**
   * `prisma.promotionApplicationMethod`: Exposes CRUD operations for the **PromotionApplicationMethod** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more PromotionApplicationMethods
    * const promotionApplicationMethods = await prisma.promotionApplicationMethod.findMany()
    * ```
    */
  get promotionApplicationMethod(): Prisma.PromotionApplicationMethodDelegate<ExtArgs, { omit: OmitOpts }>;

  /**
   * `prisma.campaignPromotion`: Exposes CRUD operations for the **CampaignPromotion** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more CampaignPromotions
    * const campaignPromotions = await prisma.campaignPromotion.findMany()
    * ```
    */
  get campaignPromotion(): Prisma.CampaignPromotionDelegate<ExtArgs, { omit: OmitOpts }>;
  ...
  /**
   * `prisma.cartPromotionAdjustment`: Exposes CRUD operations for the **CartPromotionAdjustment** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more CartPromotionAdjustments
    * const cartPromotionAdjustments = await prisma.cartPromotionAdjustment.findMany()
    * ```
    */
  get cartPromotionAdjustment(): Prisma.CartPromotionAdjustmentDelegate<ExtArgs, { omit: OmitOpts }>;
  ...
  /**
   * `prisma.orderPromotionAdjustment`: Exposes CRUD operations for the **OrderPromotionAdjustment** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more OrderPromotionAdjustments
    * const orderPromotionAdjustments = await prisma.orderPromotionAdjustment.findMany()
    * ```
    */
  get orderPromotionAdjustment(): Prisma.OrderPromotionAdjustmentDelegate<ExtArgs, { omit: OmitOpts }>;
}
