...
@Component({
  selector: 'flex-data-table-sorting-icon',
  standalone: true,
  template: `
    <svg
      width="16"
    ...
    >
      <path
        ...
        class="fill-ui-fg-muted"
        [class.fill-ui-fg-subtle]="isAscending"
      />
      <path
        ...
        class="fill-ui-fg-muted"
        [class.fill-ui-fg-subtle]="isDescending"
      />
    </svg>
  `,
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DataTableSortingIconComponent {
  @Input() direction: DataTableSortDirection | false = false;
