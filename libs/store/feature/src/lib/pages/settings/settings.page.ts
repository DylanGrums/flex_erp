...
@Component({
  selector: 'fe-store-settings-page',
  standalone: true,
  template: `
    <section class="space-y-6">
      <header>
        <h1 class="text-2xl font-semibold text-ui-fg-base">Settings</h1>
        <p class="mt-1 text-sm text-ui-fg-subtle">
          Store preferences, users, and access.
        </p>
      </header>
      ...
      <div class="medusa-panel p-6">
        ...
        <p class="mt-1 text-xs text-ui-fg-subtle">
          More tools for store configuration are on the way.
        </p>
      </div>
    </section>
  `,
