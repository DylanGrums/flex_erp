      ...
      blocks: [
        {
          ...
          type: 'highlight-card',
          name: 'Free Shipping',
          settings: { icon: 'truck', title: 'Free Shipping', description: 'On orders over $50' },
        },
        {
          id: 'highlight-2',
          type: 'highlight-card',
          name: 'Easy Returns',
          settings: { icon: 'refresh-cw', title: 'Easy Returns', description: '30-day return policy' },
        },
        {
          id: 'highlight-3',
          type: 'highlight-card',
          name: 'Secure Payment',
          settings: { icon: 'shield', title: 'Secure Payment', description: 'Your data is safe' },
        },
      ],
    },
    {
